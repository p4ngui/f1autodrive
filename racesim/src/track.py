...
class Track(pygame.sprite.Sprite):
    def __init__(self, angle=0, center_x=0, center_y=0):
        ...
        self.y = int(center_y)
        self.friction = -1
        self.track_width_cl = None
        self.center_line = None
        # self.center = (self.x, self.y)

    def set_parameters(self, track_config):
        self.params = track_config
    ...
    def prepare_track(self):
        ...
        pygame.image.save(
            self.image,
            os.path.join(self.images_path, f'{self.filename_prefix}b.png'),
        )
        # create background
    ...
    def load_track_from_csv(self):
        self.track = np.loadtxt(
            os.path.join(self.track_path, f'{self.filename_prefix}.csv'),
            comments='#',
            delimiter=',',
        )
    ...
    def scale_track(self, scale_factor=1.0):
        ...
        length_centerline = self.get_track_length()
