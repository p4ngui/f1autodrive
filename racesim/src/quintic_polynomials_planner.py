...
Positioning](http://ieeexplore.ieee.org/document/637936/)
"""
...
def quintic_polynomials_planner(sx, sy, syaw, sv, sa, gx, gy, gyaw,
                                gv, ga, max_accel, max_jerk, dt):
    """
    quintic polynomial planner input
    ...
    if show_animation:  # pragma: no cover
        plot_animation(time, sx, sy, syaw, gyaw, gx, gy, rx, ry,
                       ryaw, rv, ra, rj)

    return time, rx, ry, ryaw, rv, ra, rj


def plot_animation(time, sx, sy, syaw, gyaw, gx, gy,
                   rx, ry, ryaw, rv, ra, rj):
...
def main():
    ...
    if show_animation:  # pragma: no cover
        plot_planner(x, y, time, yaw, v, a, j)


def plot_planner(x, y, time, yaw, v, a, j):
    plt.plot(x, y, "-r")
